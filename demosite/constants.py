...
inpost_code_or_delivery_place_required = 'Wymagane jest podanie kodu paczkomatu lub ulicy + miasta gdzie jest paczkomat'
...
default_opinion_tree_header = "Dlaczego nasza oferta jest taka wyjątkowa?"
